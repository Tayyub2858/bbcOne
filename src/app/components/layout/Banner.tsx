            ...
            <div className='bg-white mt-6'>
                <div className="container mx-auto flex px-5 lg:px-24 py-8 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <p className="mb-8 text-base lg:text-xl font-medium text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
